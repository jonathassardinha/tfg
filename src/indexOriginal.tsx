...
export default class indexOriginal extends Component {
  render() {
    return (
      <div>
...
// let codeName = document.getElementById('codeName') as HTMLInputElement;
// let codeType = document.getElementById('codeType') as HTMLSelectElement;
// let typeName = document.getElementById('typeName') as HTMLInputElement;
// let typeColor = document.getElementById('typeColor') as HTMLInputElement;
...
// let v1Selector = document.getElementById('v1') as HTMLSelectElement;
// let v2Selector = document.getElementById('v2') as HTMLSelectElement;
